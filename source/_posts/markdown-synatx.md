...
- 技术
photos:
- http://lniu.qiniudn.com/images/fancybox/009.jpg
...
*   [概述](#overview)
    *   &emsp;&emsp;[宗旨](#philosophy)
    *   &emsp;&emsp;[兼容 HTML](#html)
    *   &emsp;&emsp;[特殊字符自动转换](#autoescape)

*   [区块元素](#block)
    *  &emsp;&emsp;[段落和换行](#p)
    *  &emsp;&emsp;[标题](#h3)
    *  &emsp;&emsp;[区块引用](#blockquote)
    *  &emsp;&emsp;[列表](#list)
    *  &emsp;&emsp;[代码区块](#precode)
    *  &emsp;&emsp;[分隔线](#hr)
*   [区段元素](#span)
    *  &emsp;&emsp;[链接](#link)
    *  &emsp;&emsp;[强调](#em)
    ...
    *  &emsp;&emsp;[图片](#img)
*   [其它](#misc)
    *  &emsp;&emsp;[反斜杠](#backslash)
    *  &emsp;&emsp;[自动链接](#autolink)
*   [感谢](#acknowledgement)
